report 50503 "Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Report/SalesInvoice.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(ONT_Document_Comment; EcofeeComment) { }
            column(ONT_Interest_Comment; InterestComment) { }
            ...
            dataitem("Tracking Specification"; "Tracking Specification")
            {
                ...
                column(SerialNo_TrackingSpecification; "Serial No.")
                {
                }
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(QSTRegistrationNo; CompanyInformation."QST Registration No.") { }
                    ...
                    column(CurrencyCode_SalesInvHeader; "Sales Invoice Header"."Currency Code") { }
                    ...
                    column(BilltoContact_SalesInvHeader; "Sales Invoice Header"."Bill-to Contact") { }
                    ...
                    column(Txt002Caption; Txt002CaptionLbl) { }
                    column(Txt001Caption; Txt001CaptionLbl) { }

                    column(Txt003Caption; Txt003CaptionLbl) { }
                    column(Txt004Caption; Txt004CaptionLbl) { }
                    column(Txt005Caption; Txt005CaptionLbl) { }
                    column(Txt006Caption; Txt006CaptionLbl) { }
                    column(TermsCaption; TermsCaptionLbl) { }
                    column(WeightCaption; WeightCaptionLbl) { }
                    column(PackagesCaption; PackagesCaptionLbl) { }
                    column(PrepaidCaption; PrepaidCaptionLbl) { }
                    column(TransporteurCaption; TransporteurCaptionLbl) { }
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(TempSalesInvoiceItemRefNo; TempSalesInvoiceLine."Item Reference No.") { }
                        ...
                        column(InvoicedQtyCaption; InvoicedQtyCaptionLbl) { }
                        column(BackOrderCaption; BackOrderCaptionLbl) { }
                        column(QuantityCaption; QuantityCaptionLbl) { }
                        column(UnitPriceCaption; UnitPriceCaptionLbl) { }
                        column(CADWIREtransfertCaption; CADWIREtransfertCaptionLbl) { }
                        column(BICCaption; BICCaptionLbl) { }
                        column(InstitutionNbrCaption; InstitutionNbrCaptionLbl) { }
                        column(TransitNbrCaption; TransitNbrCaptionLbl) { }
                        column(CADAccountNbrCaption; CADAccountNbrCaptionLbl) { }
            ...
            begin
                ...
                if Customer.Get("Sales Invoice Header"."Sell-to Customer No.") then begin
                    EcofeeComment := GetEcoFeesComment(Customer);
                    InterestComment := GetInterestComment(Customer);
                end;
                ...
                CurrReport.FormatRegion := cduLanguage.GetFormatRegionOrDefault("Format Region");
    ...
    var
        ...
        PONumberCaptionLbl: Label 'PO. No:';
        PODateCaptionLbl: Label 'P.O. Date';
        DateCaptionLbl: Label 'Date';
        CurrencyCaptionLbl: Label 'Currency';
        Txt001CaptionLbl: Label 'T.V.H./H.S.T./T.P.S/G.S.T';
        Txt002CaptionLbl: Label 'T.V.Q / Q.S.T';
        ...
        OrderQtyCaptionLbl: Label 'Ordered Qty';
        InvoicedQtyCaptionLbl: Label 'Invoiced Qty';
        BackOrderCaptionLbl: Label 'Back Order';
        QuantityCaptionLbl: Label 'Quantity';
        UnitPriceCaptionLbl: Label 'Unit Price';
        TotalPriceCaptionLbl: Label 'Total';
        ...
        PrepaidCaptionLbl: Label 'Prepaid';
        TransporteurCaptionLbl: Label 'Transporteur';
        CustItemNoCaptionLbl: Label 'Cust. Item No :';
        CADWIREtransfertCaptionLbl: Label 'CAD WIRE transfert / Transfert bancaire';
        BICCaptionLbl: Label 'BIC (Bank Identifier Code)';
        InstitutionNbrCaptionLbl: Label 'Institution Number (Identifiant de l’établissement)';
        TransitNbrCaptionLbl: Label 'Transit Number (no de succursale)';
        CADAccountNbrCaptionLbl: Label 'CAD Account Number (# de compte)';
        Txt003CaptionLbl: Label 'Cette facture portera intérêt de dix-huit pourcent (18%) l’an calculé mensuellement, sur';
        Txt004CaptionLbl: Label 'tout solde non acquitté dans les termes de cette facture. Les droits de possession sur la';
        Txt005CaptionLbl: Label 'marchandise demeureront la propriété de Cycles Devinci Inc. jusqu’à paiement complet';
        Txt006CaptionLbl: Label 'de la présente facture.';
        EcofeeComment: Text;
        InterestComment: Text;
    ...
    /// </summary>
    /// <param name="TempSalesInvoiceLine">Temporary Record "Sales Invoice Line".</param>
    ...
    /// TreatAsmLineBuffer.
    /// </summary>
    /// <param name="PostedAsmLine">Record "Posted Assembly Line".</param>
    ...
    procedure GetInterestComment(var Customer: Record Customer) Result: Text[1024]
    var
        InterestRec: Record "Document Comment";
        LangCode: Code[10];
    begin
        LangCode := Customer."Language Code";

        InterestRec.Reset();
        InterestRec.SetRange("Language Code", LangCode);
        InterestRec.SetRange("Object Type", InterestRec."Object Type"::Interest);

        if InterestRec.FindFirst() then
            exit(InterestRec.Comment);
