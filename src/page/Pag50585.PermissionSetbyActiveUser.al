page 50585 "Permission Set by Active User"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Permission Set by Active User';
    AboutTitle = 'About Permission Set by Active User';
    AboutText = 'Get an overview of how permission sets are assigned to your Active users within a company. Tip: If you go into analysis mode, you can analyze data in other ways than what you see in the list.';
