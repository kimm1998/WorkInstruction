page 50570 "ONT Change Sts on Prod. Order"
{
    ...
    layout
    {
        area(content)
        {
            ...
            field(CreateTransfer; CreateTransfer)
            {
                ApplicationArea = all;
...
#pragma warning restore AA0074
    ...
    procedure ReturnPostingInfo(var Status: Enum "Production Order Status"; var PostingDate2: Date; var UpdUnitCost: Boolean; var CreateTrnsfr: Boolean)
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
