page 50568 "ONT Lot Expiry Workbench"
{
    Caption = 'Lot Expiry Workbench';
    PageType = List;
    ...
    begin
        ...
        // ExpiryQuickFilter := "ONT Expiry Quick Filter"::NextMonth;
        ApplyExpiryQuickFilter();
        rec.SetRange("ONT Use Expiration Dates", true);
    ...
    begin
        ...
        if Lot.FindSet() then
            repeat
                if MaintCalc.IsDueInWindow(Lot, MaintQuickFilter) then
                    Lot.Mark(true);
            until Lot.Next() = 0;
