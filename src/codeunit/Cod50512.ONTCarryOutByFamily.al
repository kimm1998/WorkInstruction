// codeunit 50512 "ONT Carry Out By Family"
// {
...
//         i: Integer;
//     begin
//         CollectGroups(WorksheetTemplateName, WorksheetBatchName, FamilyList, LocationList, DueDateList, ItemsList);
...
//         var FamilyList: list of [code[20]]; var LocationList: List of [Code[10]]; var DueDateList: List of [Date]; var ItemsList: list of [code[20]])
//     var
...
//         SignleInstance: Codeunit "Single Instance";
...
//             NewFamilyNo := GetNextFamilyVariantNo(OriginalFamilyNo);// check here for pierre

//             NewFamily.Init();
//             NewFamily.TransferFields(OriginalFamily, false);
//             NewFamily."No." := NewFamilyNo;
//             NewFamily."Product Type" := warehouseSetup."Production Type Code";
...
//         Commit();
//         SignleInstance.SetItemNo(ItemNo);
...
//         WorksheetTemplateName: Code[10]; WorksheetBatchName: Code[10];
//         LocationCode: Code[10]; DueDate: Date)
//     var
...
//     [EventSubscriber(ObjectType::Codeunit, Codeunit::"Create Prod. Order Lines", OnCopyFromFamilyOnAfterFamilyLineSetFilters, '', False, False)]
//     local procedure FilterProdOrderFamilyLinesByItemNo(ProductionOrder: Record "Production Order"; var FamilyLine: Record "Family Line")
//     var
//         SingleInstance: Codeunit "Single Instance";
//     begin
//         FamilyLine.SetRange("Item No.", SingleInstance.GetItemNo());
//     end;
// }
