...
codeunit 50523 "ONT Prod. Ordr Stats Mangmnt"
{
    ...
    var
        ...
        IsHandled: Boolean;
        TransferSubcontractOrders: Codeunit "ONTCreateSubcontractTransfers";
    begin
        IsHandled := false;
        ...
        ChangeStatusOnProdOrderPage.Set(Rec);
        if ChangeStatusOnProdOrderPage.RunModal() = ACTION::Yes then begin
            ...
            if NewStatus = NewStatus::Released then
                TransferSubcontractOrders.CreateTransfersForAllProdOrders(ToProdOrder."No.");
            if NewCreateTransfer then
                TransferMgt.RunForProductionOrder(NewStatus, ToProdOrder."No.");
            Commit();
...
#pragma warning restore AA0074
    ...
    begin
        ...
        ToProdOrder."ONT Original Due Date" := FromProdOrder."ONT Original Due Date";
